...
#define APP_TIMER_MAX_TIMERS        (3+BSP_APP_TIMERS_NUMBER)          /**< Maximum number of timers used by the application. */
...
#define DEVICE_NAME                      "Wlock_v1.08"                                    /**< Name of device used for advertising. */
